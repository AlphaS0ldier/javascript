...
export const getLastPrincipalOfDirector = () => {
  let arrmovies = movie.director.notableFilmography;
  return arrmovies[arrmovies.length - 1];
};
...
export const getDescriptionOfGandalf = () => {
  return movie.characters[
    movie.characters.findIndex((movie) => movie.name === "Gandalf")
  ].description;
};
...
export const getRealOfAragorn = () => {
  return movie.characters[
    movie.characters.findIndex((movie) => movie.name === "Aragorn")
  ].actor;
};
